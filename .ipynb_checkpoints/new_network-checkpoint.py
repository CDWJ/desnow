...
5. included downsampling and upsampling
'''
...
class atrous_Conv(nn.Module):
    def __init__(self, inplanes, rate, num_classes=3):
        ...
        self.fc1 = conv_Block(planes, planes, kernel_size=1, stride=1, padding=0)
        self.fc2 = deconv_Block(planes, planes, kernel_size=3, stride=2, padding=1, output_padding=1)
        self.fc3 = deconv_Block(planes, planes, kernel_size=3, stride=2, padding=1, output_padding=1)
        self.fc4 = deconv_Block(planes, planes, kernel_size=3, stride=2, padding=1, output_padding=1)
